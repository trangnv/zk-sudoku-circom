...
# Variable to store the number for the ptau file which should be sufficient for the circuit constraints
PTAU=14
...
snarkjs zkey contribute ${CIRCUIT}_0000.zkey ${CIRCUIT}_final.zkey --name="trangnv" -v -e="01"
